...
**Issue**: Research: reporting docker dependencies **Date**: 2026-01-09
**Status**: Research Complete - Ready for Implementation

## Quick Summary

Docker container dependencies can be successfully added to the
actions-dependency-submission action using the PURL (Package URL) standard. This
will enable vulnerability tracking for Docker images used in GitHub Actions
workflows.

## Three Docker Usage Patterns to Support

**Note:** Service containers (`jobs.<job_id>.services`) are also supported as
they use the same Docker image format.
...
**Reference**:
[PURL Docker Specification](https://github.com/package-url/purl-spec/blob/main/types-doc/docker-definition.md)
...
**Security Advisories**: Notifications for vulnerable images ✅ **Supply Chain
Visibility**: Complete dependency view

### Compliance

✅ **SBOM**: Complete software bill of materials ✅ **License Tracking**:
Understand container licenses ✅ **Audit Trail**: Historical dependency records

### Operations

✅ **Dependency Review**: Block PRs with vulnerable images ✅ **Version
Tracking**: See which workflows use which images ✅ **Update Management**:
...
**Full Research Document**: See `docs/docker-dependency-research.md` for
complete details
...
**Spec-Compliant**: Full PURL standard support ✅ **Non-Breaking**: Can be added
without disrupting existing functionality ✅ **Well-Scoped**: Realistic 2-week
timeline
...
**Next Steps**: Awaiting approval to begin implementation. Once approved,
implementation can begin with Phase 1 (Parser Enhancement).
